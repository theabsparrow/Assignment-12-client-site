...
const MyComment = ({ userComment }) => {
    const { comment, commentId, creationTime } = userComment;
        ...
        <>
            <tr>
                ...
                <td className="px-4 py-4 text-sm whitespace-nowrap">
                    <div>
                        <h4 className="text-gray-700 dark:text-gray-200 bg-[#4E31B069] inline px-3 py-1 font-normal rounded-full">{comment}</h4>
                    </div>
                </td>
