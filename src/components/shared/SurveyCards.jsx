    ...
    return (
        <div className='shadow-xl rounded-xl font-poppins border-[1px] border-gray-400 relative px-5'>
            <div className='flex justify-center'>
                ...
                {category === "Education" && <img className='lg:w-[20vw] rounded-xl' src={Education} alt="" />}
            ...
            <div className='absolute z-10 top-20 lg:top-6 left-2 px-3'>
                ...
                <div className='flex flex-col'>
                    <div className='text-center mt-5 space-y-4'>
                        <h1 className='text-5xl lg:text-4xl font-bold bg-[#CFD7DFCC] rounded-xl px-3 py-1 '>{title}</h1>
                        <h1 className='text-2xl lg:text-lg font-medium bg-[#CFD7DFCC] rounded-xl px-3 py-1'>{description}</h1>
                    </div>
                    <div className='flex justify-between mt-4'>
                        <Link to={`/survey/${id}`} className='bg-[#859770] text-xl lg:text-base text-black px-3 py-1 font-medium rounded-xl hover:bg-black hover:text-white duration-500'> Explore More</Link>
